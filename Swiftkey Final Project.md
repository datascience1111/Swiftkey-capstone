...
The project's prediction model discovered some limitations and opportunities:

- Speed : Given its design, this project's objects requires at least 10 MB memory space, an element which increases runtime, thus hindering speed performance.
